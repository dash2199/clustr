...
export const metadata: Metadata = {
  title: "Clustr — Multi-Agent Workspace for AI Coding",
  description:
    "Orchestrate multiple AI coding agents in one workspace. Spawn Claude, Codex, and more — all collaborating in real time.",
